...
local function GetScale()
    if IsMobile then
        local BaseWidth = 550;
        local scale = math.clamp(ScreenWidth / BaseWidth, 0.55, 1.0);
        return scale;
    end
    return 1;
end
...
function Library:CreateLabel(Properties, IsHud)
    local fontSize = Properties.TextSize or 16;
    local scaledSize = IsMobile and S(fontSize) or fontSize;
    ...
    local ScaledProperties = {};
    for k, v in next, Properties do
        ScaledProperties[k] = v;
    end;
    if IsMobile and ScaledProperties.TextSize then
        ScaledProperties.TextSize = S(ScaledProperties.TextSize);
    end;
    return Library:Create(_Instance, ScaledProperties);
end;
    ...
    if IsMobile then
        ...
        Instance.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.Touch then
                ...
                if ObjPos.Y > (Cutoff or S(40)) then
                    return;
                end;
                DragStartPos = Input.Position;
                FrameStartPos = Instance.Position;
                Input.Changed:Connect(function()
                    if Input.UserInputState == Enum.UserInputState.Change then
                        Instance.Position = UDim2.new(
                            0,
                            FrameStartPos.X.Offset + (Input.Position.X - DragStartPos.X) + (Instance.Size.X.Offset * Instance.AnchorPoint.X),
                            0,
                            FrameStartPos.Y.Offset + (Input.Position.Y - DragStartPos.Y) + (Instance.Size.Y.Offset * Instance.AnchorPoint.Y)
                        );
                    end;
                end);
            end;
...
function Library:AddToolTip(InfoStr, HoverInstance)
    local X, Y = Library:GetTextBounds(InfoStr, Library.Font, S(14));
    local Tooltip = Library:Create('Frame', {
        BackgroundColor3 = Library.MainColor,
        BorderColor3 = Library.OutlineColor,
        Size = UDim2.fromOffset(X + S(5), Y + S(4)),
        ZIndex = 100,
        Parent = Library.ScreenGui,
        Visible = false,
    })
    local Label = Library:CreateLabel({
        Position = UDim2.fromOffset(S(3), S(1)),
    ...
    if IsMobile then
        ...
        HoverInstance.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.Touch then
                IsHovering = true;
                Tooltip.Position = UDim2.fromOffset(Input.Position.X + S(15), Input.Position.Y + S(12));
...
function Library:GetInputPosition()
    if IsMobile then
        local loc = InputService:GetMouseLocation();
        return loc.X, loc.Y;
    end;
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        local DisplayFrame = Library:Create('Frame', {
            ...
            Size = UDim2.new(0, dispW, 0, dispH);
            ZIndex = 6;
            Parent = ToggleLabel;
        });
        local CheckerFrame = Library:Create('ImageLabel', {
            BorderSizePixel = 0;
            Size = UDim2.new(0, dispW - 1, 0, dispH - 1);
            ZIndex = 5;
        ...
        local PickerFrameOuter = Library:Create('Frame', {
            ...
            Position = UDim2.fromOffset(DisplayFrame.AbsolutePosition.X, DisplayFrame.AbsolutePosition.Y + S(18)),
        ...
        DisplayFrame:GetPropertyChangedSignal('AbsolutePosition'):Connect(function()
            PickerFrameOuter.Position = UDim2.fromOffset(DisplayFrame.AbsolutePosition.X, DisplayFrame.AbsolutePosition.Y + S(18));
        end)
        ...
        local SatVibMapOuter = Library:Create('Frame', {
            BorderColor3 = Color3.new(0, 0, 0);
            Position = UDim2.new(0, S(4), 0, S(25));
            Size = UDim2.new(0, mapSize, 0, mapSize);
            ZIndex = 17;
            Parent = PickerFrameInner;
        });
        ...
        local HueSelectorOuter = Library:Create('Frame', {
            BorderColor3 = Color3.new(0, 0, 0);
            Position = UDim2.new(0, hueBarX, 0, S(25));
            Size = UDim2.new(0, hueBarW, 0, mapSize);
            ZIndex = 17;
            Parent = PickerFrameInner;
        });
        ...
        local HueBoxOuter = Library:Create('Frame', {
            BorderColor3 = Color3.new(0, 0, 0);
            Position = UDim2.fromOffset(S(4), boxY),
            Size = UDim2.new(0.5, -S(6), 0, boxH),
            ZIndex = 18,
            Parent = PickerFrameInner;
        });
        ...
        local RgbBoxBase = Library:Create(HueBoxOuter:Clone(), {
            Position = UDim2.new(0.5, S(2), 0, boxY),
            Size = UDim2.new(0.5, -S(6), 0, boxH),
            Parent = PickerFrameInner
        });
        local RgbBox = Library:Create(RgbBoxBase.Frame:FindFirstChild('TextBox') or RgbBoxBase:FindFirstChildWhichIsA('TextBox') or RgbBoxBase:GetChildren()[1], {
            Text = '255, 255, 255',
        ...
        if Info.Transparency then
            TransparencyBoxOuter = Library:Create('Frame', {
                BorderColor3 = Color3.new(0, 0, 0);
                Position = UDim2.fromOffset(S(4), S(251));
                Size = UDim2.new(1, -S(8), 0, S(15));
                ZIndex = 19;
                Parent = PickerFrameInner;
            });
        ...
        local DisplayLabel = Library:CreateLabel({
            ...
            Position = UDim2.fromOffset(S(5), S(5));
            TextXAlignment = Enum.TextXAlignment.Left;
            TextSize = S(14);
        ...
        do
            ...
            local function updateMenuPosition()
                ContextMenu.Container.Position = UDim2.fromOffset(
                    (DisplayFrame.AbsolutePosition.X + DisplayFrame.AbsoluteSize.X) + S(4),
                    DisplayFrame.AbsolutePosition.Y + 1
                )
            end
            local function updateMenuSize()
                local menuWidth = S(60)
                ...
                ContextMenu.Container.Size = UDim2.fromOffset(
                    menuWidth + S(8),
                    ContextMenu.Inner.Layout.AbsoluteContentSize.Y + S(4)
                )
            end
        ...
        local function HandleDragOnFrame(Frame, OnMove)
            Frame.InputBegan:Connect(function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1
                    ...
                    if IsMobile then
                        Input.Changed:Connect(function()
                            if Input.UserInputState == Enum.UserInputState.Change then
                                processInput(Input.Position.X, Input.Position.Y)
                            end
                        end)
                        Input.Changed:Connect(function()
        ...
        HandleDragOnFrame(SatVibMap, function(x, y)
        ...
        HandleDragOnFrame(HueSelectorInner, function(x, y)
        ...
        if TransparencyBoxInner then
            HandleDragOnFrame(TransparencyBoxInner, function(x, y)
        ...
        Library:GiveSignal(InputService.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1
                ...
                if px < AbsPos.X or px > AbsPos.X + AbsSize.X
                    or py < (AbsPos.Y - S(20) - 1) or py > AbsPos.Y + AbsSize.Y then
                    ColorPicker:Hide();
                end;
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        local ModeSelectOuter = Library:Create('Frame', {
            BorderColor3 = Color3.new(0, 0, 0);
            Position = UDim2.fromOffset(ToggleLabel.AbsolutePosition.X + ToggleLabel.AbsoluteSize.X + S(4), ToggleLabel.AbsolutePosition.Y + 1);
            Size = UDim2.new(0, S(60), 0, S(45) + 2);
            Visible = false;
            ZIndex = 14;
            Parent = ScreenGui;
        });
        ToggleLabel:GetPropertyChangedSignal('AbsolutePosition'):Connect(function()
            ModeSelectOuter.Position = UDim2.fromOffset(ToggleLabel.AbsolutePosition.X + ToggleLabel.AbsoluteSize.X + S(4), ToggleLabel.AbsolutePosition.Y + 1);
        end);
        ...
        function KeyPicker:Update()
            ...
            Library.KeybindFrame.Size = UDim2.new(0, math.max(XSize + S(10), S(210)), 0, YSize + S(23))
        end;
        ...
        PickOuter.InputBegan:Connect(function(Input)
            if (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch)
                ...
                if IsMobile then
                    if PickerFrameOuter and PickerFrameOuter.Visible then return end
        ...
        Library:GiveSignal(InputService.InputBegan:Connect(function(Input)
            ...
            if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                ...
                if Mouse.X < AbsPos.X or Mouse.X > AbsPos.X + AbsSize.X
                    or Mouse.Y < (AbsPos.Y - S(20) - 1) or Mouse.Y > AbsPos.Y + AbsSize.Y then
                    ModeSelectOuter.Visible = false;
                end;
            end;
        end))
...
do
    ...
    function Funcs:AddLabel(Text, DoesWrap)
        ...
        if DoesWrap then
            local Y = select(2, Library:GetTextBounds(Text, Library.Font, S(14), Vector2.new(TextLabel.AbsoluteSize.X, math.huge)))
            TextLabel.Size = UDim2.new(1, -S(4), 0, Y)
        else
            Library:Create('UIListLayout', {
    ...
    function Funcs:AddButton(...)
        ...
        function Button:AddButton(...)
            ...
            self.Outer.Size = UDim2.new(0.5, -2, 0, S(20))
            SubButton.Outer, SubButton.Inner, SubButton.Label = CreateBaseButton(SubButton)
            SubButton.Outer.Position = UDim2.new(1, S(3), 0, 0)
    ...
    function Funcs:AddInput(Idx, Info)
        ...
        local function Update()
            local PADDING = 2
            local reveal = InnerContainer.AbsoluteSize.X
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        local ToggleLabel = Library:CreateLabel({
            Size = UDim2.new(0, S(216), 1, 0);
            Position = UDim2.new(1, S(6), 0, 0);
            TextSize = S(14);
            Text = Info.Text;
            TextXAlignment = Enum.TextXAlignment.Left;
            ZIndex = 6;
        ...
        local hitSize = IsMobile and S(200) or 170;
        local ToggleRegion = Library:Create('Frame', {
            BackgroundTransparency = 1;
            Size = UDim2.new(0, hitSize, 1, 0);
            ZIndex = 8;
            Parent = ToggleOuter;
        });
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        SliderInner.InputBegan:Connect(function(Input)
            if (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch)
                and not Library:MouseIsOverOpenedFrame() then
                local startX = IsMobile and Input.Position.X or Mouse.X;
                local mPos = startX;
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        local DropdownArrow = Library:Create('ImageLabel', {
            ...
            BackgroundTransparency = 1;
            Position = UDim2.new(1, -S(16), 0.5, 0);
        ...
        local ListOuter = Library:Create('Frame', {
            BorderColor3 = Color3.new(0, 0, 0);
            Position = UDim2.new(0, S(4), 0, S(20) + RelativeOffset + 1 + S(20));
            Size = UDim2.new(1, -S(8), 0, MAX_DROPDOWN_ITEMS * S(20) + 2);
            ZIndex = 20;
            Visible = false;
        ...
        local Scrolling = Library:Create('ScrollingFrame', {
            ...
            ScrollBarThickness = IsMobile and S(5) or 3,
        ...
        function Dropdown:SetValues()
            ...
            local Y = math.clamp(Count * S(20), 0, MAX_DROPDOWN_ITEMS * S(20)) + 1;
            ListOuter.Size = UDim2.new(1, -S(8), 0, Y);
            Scrolling.CanvasSize = UDim2.new(0, 0, 0, (Count * S(20)) + 1);
        end;
...
do
    Library.NotificationArea = Library:Create('Frame', {
        ...
        Size = UDim2.new(0, S(300), 0, S(200));
        ZIndex = 100;
        Parent = ScreenGui;
    });
    Library:Create('UIListLayout', {
    ...
    local WatermarkOuter = Library:Create('Frame', {
        BorderColor3 = Color3.new(0, 0, 0);
        Position = UDim2.new(0, S(1000), 0, -S(25));
        Size = UDim2.new(0, S(213), 0, S(20));
        ZIndex = 200;
        Visible = false;
        Parent = ScreenGui;
    });
...
function Library:SetWatermark(Text)
    local X, Y = Library:GetTextBounds(Text, Library.Font, S(14));
    Library.Watermark.Size = UDim2.new(0, X + S(15), 0, (Y * 1.5) + S(3));
    Library:SetWatermarkVisibility(true)
    Library.WatermarkText.Text = Text;
end;
function Library:Notify(Text, Time)
    local XSize, YSize = Library:GetTextBounds(Text, Library.Font, S(14));
    YSize = YSize + S(7)
    local NotifyOuter = Library:Create('Frame', {
        BorderColor3 = Color3.new(0, 0, 0);
        Position = UDim2.new(0, S(100), 0, S(10));
    ...
    local LeftColor = Library:Create('Frame', {
        ...
        BorderSizePixel = 0;
        Position = UDim2.new(0, -1, 0, -1);
        Size = UDim2.new(0, S(3), 1, 2);
        ZIndex = 104;
        Parent = NotifyOuter;
    });
    Library:AddToRegistry(LeftColor, { BackgroundColor3 = 'AccentColor'; }, true);
    pcall(NotifyOuter.TweenSize, NotifyOuter, UDim2.new(0, XSize + S(8) + S(4), 0, YSize), 'Out', 'Quad', 0.4, true);
    task.spawn(function()
        task.wait(Time or 5);
...
function Library:CreateWindow(...)
    ...
    if IsMobile then
        local mobileW = math.min(ScreenWidth - S(20), S(550));
        local mobileH = math.min(ScreenHeight - S(60), S(600));
        Config.Position = UDim2.fromOffset(S(10), S(30));
        Config.Size = UDim2.fromOffset(mobileW, mobileH);
    ...
    local sideH = IsMobile and (Config.Size.Y.Offset - S(80)) or 507;
    ...
    function Window:AddTab(Name)
        ...
        local TabButtonWidth = Library:GetTextBounds(Name, Library.Font, S(16));
        local TabButton = Library:Create('Frame', {
            BackgroundColor3 = Library.BackgroundColor;
            BorderColor3 = Library.OutlineColor;
            Size = UDim2.new(0, TabButtonWidth + S(8) + S(4), 1, 0);
            ZIndex = 1;
            Parent = TabArea;
        });
        ...
        local LeftSide = Library:Create('ScrollingFrame', {
            BackgroundTransparency = 1;
            BorderSizePixel = 0;
            Position = UDim2.new(0, S(8) - 1, 0, S(8) - 1);
            Size = UDim2.new(0.5, -S(12) + 2, 0, sideH + 2);
            CanvasSize = UDim2.new(0, 0, 0, 0);
            BottomImage = '';
            TopImage = '';
        ...
        local RightSide = Library:Create('ScrollingFrame', {
            BackgroundTransparency = 1;
            BorderSizePixel = 0;
            Position = UDim2.new(0.5, S(4) + 1, 0, S(8) - 1);
            Size = UDim2.new(0.5, -S(12) + 2, 0, sideH + 2);
            CanvasSize = UDim2.new(0, 0, 0, 0);
            BottomImage = '';
            TopImage = '';
        ...
        function Tab:AddGroupbox(Info)
            ...
            local GroupboxLabel = Library:CreateLabel({
                Size = UDim2.new(1, 0, 0, S(18));
                Position = UDim2.new(0, S(4), 0, S(2));
                TextSize = S(14);
                Text = Info.Name;
                TextXAlignment = Enum.TextXAlignment.Left;
                ZIndex = 5;
            ...
            local Container = Library:Create('Frame', {
                BackgroundTransparency = 1;
                Position = UDim2.new(0, S(4), 0, S(20));
                Size = UDim2.new(1, -S(4), 1, -S(20));
                ZIndex = 1;
                Parent = BoxInner;
            });
            Library:Create('UIListLayout', {
            ...
            function Groupbox:Resize()
                ...
                BoxOuter.Size = UDim2.new(1, 0, 0, S(20) + Size + 2 + 2);
            end;
    ...
    if IsMobile then
        local ToggleButton = Library:Create('TextButton', {
            ...
            BackgroundColor3 = Library.AccentColor;
            BorderSizePixel = 0;
            Position = UDim2.new(1, -S(10), 0, S(10));
            Size = UDim2.new(0, S(44), 0, S(44));
            Text = '☰';
        ...
        Library:Create('UICorner', {
            CornerRadius = UDim.new(0, S(8));
            Parent = ToggleButton;
        });
        Library:AddToRegistry(ToggleButton, { BackgroundColor3 = 'AccentColor' });
